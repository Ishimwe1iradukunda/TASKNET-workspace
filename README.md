[README.md](https://github.com/notion-workspace-d2r8e5c82vjq7ves8oj0.lp.dev/README.md)
# TaskNet

**TaskNet** is an all-in-one open-source productivity and project
management platform designed for teams and individuals. It combines task
tracking, project management, collaboration, and data handling into a
single self-hosted system.

With **no signup or account creation required**, anyone can immediately
start creating tasks, managing projects, chatting with team members, and
organizing workflows in a shared environment.
...
``` bash
docker build -t tasknet .
docker run -p 3000:3000 tasknet
```
...
- Push the branch and open a Pull Reques
...
[LICENSE])                                  Apache License
   ...
   Copyright 2025 IRADUKUNDA ISHIMWE EMMANUEL and TaskNet. All rights reserved.
...
TaskNet is inspired by the best parts of:\
- **Notion** -- for notes and docs\
- **Trello** -- for boards and task management\
- **Asana** -- for collaboration and goals
