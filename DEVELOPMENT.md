...
```bash
git remote add encore encore://notion-workspace-2fai
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/notion-workspace-2fai/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/notion-workspace-2fai/settings/integrations/github)
